...
new (0, _app.App)((0, _model.model)).init(); //import { Site } from "./classes/site";
...
var _image1Png = require("./assets/image1.png");
...
`;
const model = [
    new (0, _blocks.TitleBlock)("Pure JavaScript Website Builder", {
        tag: "h2",
    ...
    new (0, _blocks.ImageBlock)((0, _image1PngDefault.default), {
        styles: {
            padding: "2rem 0",
            display: "flex",
...
},{"./assets/image1.png":"6JYkF","./classes/blocks":"gMfMj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6JYkF":[function(require,module,exports) {
module.exports = require("365483f22732475d").getBundleURL("bLxZJ") + "image1.38a4bd5a.png" + "?" + Date.now();

},{"365483f22732475d":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
class Block {
    ...
    toHTML() {
        throw new Error("The method of HTML must be realized");
    }
}
...
},{"../utils":"en4he","./blocks":"gMfMj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"clPKd":[function() {},{}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequire7af7")
